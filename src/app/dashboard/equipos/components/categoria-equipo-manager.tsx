...
export function CategoriaEquipoManager({ open, onOpenChange }: CategoriaEquipoManagerProps) {
   ...
   function startEdit(cat: CategoriaEquipo) {
      ...
      setEditMedidaCobroId(cat.medida_cobro_id);
   ...
   async function saveEdit(id: string) {
      ...
      try {
         const result = await UpdateCategoriaEquipo(id, {
            ...
            medida_cobro_id: editMedidaCobroId.trim(),
                                 ...
                                 <div className="flex flex-col gap-2">
                                    <div className="grid grid-cols-2 gap-2">
                                       ...
                                       <div className="flex flex-col justify-between">
                                          ...
                                          <select
                                             value={editMedidaCobroId}
                                             onChange={(e) => {
                                                setEditMedidaCobroId(e.target.value);
                                                setEditCobraEn(MedidaCobros.find(m => m.id === e.target.value)?.nombre || "");
                                             }}
                                             className={SELECT_CLASS}
                                             required
                                          >
