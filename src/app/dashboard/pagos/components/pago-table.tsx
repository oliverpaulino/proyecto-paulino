               ...
               <tbody>
                  {pagos.map((p) => {
                     const isEntrada = p.tipo_movimiento === 'ENTRADA';
                      const destinoNombre = p.gasto_codigo_referencia || p.costo_codigo_referencia || p.deduccion_codigo_referencia || p.proyecto_codigo_referencia || p.orden_compra_codigo_referencia || "N/A";
