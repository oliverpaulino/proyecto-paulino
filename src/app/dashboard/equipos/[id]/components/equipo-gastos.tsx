...
export function EquipoGastos({ equipoId }: { equipoId: string }) {
   const { Gastos, loading, pagination, GetGastos, NextPage, PrevPage } = useGastoStore();
