...
export function CostoFilters({ viewLimit = 20 }: { viewLimit?: number }) {
   const { currentFilters, GetCostos } = useCostoStore();
   ...
   }, [searchQuery, startDate, endDate, viewLimit, GetCostos]);
