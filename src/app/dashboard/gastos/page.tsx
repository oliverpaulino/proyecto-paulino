...
import { GastoTable } from "./components/gasto-table";
import { GastoFilters } from "./components/gasto-filters";

export default function GastosPage() {
   const { Gastos, loading, pagination, CreateGasto, NextPage, PrevPage } = useGastoStore();

   const [formLoading, setFormLoading] = useState(false);
   const [createOpen, setCreateOpen] = useState(false);

   async function handleCreate(data: CreateGastoForm) {
      setFormLoading(true);
      try {
      ...
      <div className="flex flex-col gap-6 p-6">
         ...
         <div>
            ...
            <p className="mt-1.5 ml-11 text-sm text-muted-foreground">
               Registro y control de gastos operativos, administrativos y financieros.
            </p>
            ...
            <Dialog open={createOpen} onOpenChange={setCreateOpen}>
               ...
               <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
                  <DialogHeader>
                     ...
                     <DialogDescription>
                        Ingresa los detalles del comprobante y la categoría correspondiente.
                     </DialogDescription>
                  </DialogHeader>
                  <GastoForm
