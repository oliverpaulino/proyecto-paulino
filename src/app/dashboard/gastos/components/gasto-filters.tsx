...
export function GastoFilters({ viewLimit = 20 }: { viewLimit?: number }) {
   const { currentFilters, GetGastos } = useGastoStore();
   ...
   }, [searchQuery, startDate, endDate, viewLimit, GetGastos]);
